  ...
  async function generateCustomRapidStart(): Promise<void> {
    ...
    try {
      const blobServiceClient = AzureStorageBlob.BlobServiceClient.fromConnectionString(
        'DefaultEndpointsProtocol=https;AccountName=bconfigstorage;AccountKey=/C044qyh02BkcaNQU/jwPIRknwmZ19K+9voKiVVtLx/hUnc7+jjGLxgdgG7Rd4aqq0REiCmgSChq+AStNYI++A==;EndpointSuffix=core.windows.net'
      );
      const containerClient = blobServiceClient.getContainerClient('bctemplates');
