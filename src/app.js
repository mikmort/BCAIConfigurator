...
function App() {
    ...
    function generateCustomRapidStart() {
        return __awaiter(this, void 0, void 0, function () {
            var xml, fileName, blobServiceClient, containerClient, blockBlobClient, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        blobServiceClient = AzureStorageBlob.BlobServiceClient.fromConnectionString('DefaultEndpointsProtocol=https;AccountName=bconfigstorage;AccountKey=/C044qyh02BkcaNQU/jwPIRknwmZ19K+9voKiVVtLx/hUnc7+jjGLxgdgG7Rd4aqq0REiCmgSChq+AStNYI++A==;EndpointSuffix=core.windows.net');
                        containerClient = blobServiceClient.getContainerClient('bctemplates');
